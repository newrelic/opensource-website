...
const projectPage = () => {
  ...
  return (
    <StaticQuery
      query={graphql`
        query {
          allProjectsJson(filter: { name: { eq: "nr1-workload-geoops" } }) {
            nodes {
              ...projectFields
            }
          }
          ...
          <Layout hasHeaderBg>
            ...
            <div className="primary-content">
              <main className="primary-content-main">
                ...
                <p>
                  Donec sed odio dui. Donec sed odio dui. Cras justo odio,
                  dapibus ac facilisis in, egestas eget quam. Duis mollis, est
                  non commodo luctus, nisi erat porttitor ligula, eget lacinia
                  odio sem nec elit. Vestibulum id ligula porta felis euismod
                  semper. Cum sociis natoque penatibus et magnis dis parturient
                ...
                <p>
                  ...
                  consectetur et. Maecenas faucibus mollis interdum. Lorem ipsum
                ...
                <blockquote>
                  Vitae enim egestas egestas at gravida arcu, amet in. Facilisis
                  at massa amet, aliquet dui semper. Sit placerat sed et ornare
                  faucibus egestas sit nisl, diam.
                ...
                <p>
                  Curabitur blandit tempus porttitor. Cum sociis natoque
                ...
                <p>
                  ...
                  id elit non mi porta gravida at eget metus. Donec ullamcorper
                  nulla non metus auctor fringilla. Nulla vitae elit libero, a
                  pharetra augue. Praesent commodo cursus magna, vel scelerisque
              ...
              <aside className="primary-content-aside">
                <div className={styles.callToActionContainer}>
                  ...
                  <div className={styles.callToActionCategorySpecification}>
                    ...
                    <p className={styles.callToActionDescription}>
                      ...
                      available for installation and configuration via the New
                      Relic One Homepage. You can install it via the Catalog
                ...
                <ul className={styles.repoStats}>
                  ...
                  <li
                    className={`${styles.repoStat} ${styles.repoStatReleases}`}
                  >
                    <img
                      src={tagIcon}
                      alt="release icon"
                  ...
                  <li
                    className={`${styles.repoStat} ${styles.repoStatCommits}`}
                  >
                    <img
                      src={commitIcon}
                      alt="commit icon"
                  ...
                  >
                    ...
                    <span className={styles.repoStatLabel}>
                      Open Pull Requests
                    </span>
                  </li>
