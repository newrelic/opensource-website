...
date: "05/01/2020"
title: "Node New Relic Couchbase"
projectConfig: "src/data/projects/newrelic-experimental-node-newrelic-couchbase.json"
---

## Getting Started

Go to the project's [README](https://github.com/newrelic-experimental/node-newrelic-couchbase#readme) for setup and usage details.
...
This is how you extend Node New Relic Couchbase in following way.
