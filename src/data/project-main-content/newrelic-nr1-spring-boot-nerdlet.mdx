---
path: "/projects/newrelic/nr1-spring-boot-nerdlet"
date: "05/01/2020"
title: "New Relic One Spring Boot"
projectConfig: "src/data/projects/newrelic-nr1-spring-boot-nerdlet.json"
---

## Getting Started

Go to the project's [README](https://github.com/newrelic/nr1-spring-boot-nerdlet) for setup and usage details.
...
This is how you extend New Relic One Spring Boot in following way.
