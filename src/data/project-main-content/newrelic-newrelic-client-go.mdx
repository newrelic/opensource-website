...
Go to the project's [README](https://github.com/newrelic/newrelic-client-go) for setup and usage details.
...
This is how you extend New Relic Go Client in following way.
