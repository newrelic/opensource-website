---
path: "/projects/newrelic/dotnet-agent"
date: "05/15/2020"
title: "New Relic .NET Agent"
projectConfig: "src/data/projects/newrelic-dotnet-agent.json"
---

## Getting Started

Go to the project's [README](https://github.com/newrelic/dotnet-agent) for setup and usage details.
...
This is how you extend New Relic .NET Agent in following way.
