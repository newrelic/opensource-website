...
Go to the project's [README](https://github.com/newrelic/newrelic-unix-monitor#readme) for setup and usage details.
...
This is how you extend New Relic Unix Monitor in following way.
